...
declared_client_ids='["headlamp","argocd","proxmox","portainer","s3","tinyauth","beszel","immich","paperless","opencloud-web","OpenCloudDesktop","OpenCloudAndroid","OpenCloudIOS"]'
